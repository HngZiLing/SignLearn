...
import 'package:signlearn/model/question6.dart';

class QuizPage6 extends StatefulWidget {
  final String categoryTitle, categoryId;
  const QuizPage6({Key? key, required this.categoryTitle, required this.categoryId}) : super(key: key);
  @override
  State<QuizPage6> createState() => _QuizPageState();
}

class _QuizPageState extends State<QuizPage6>{
                  ...
                  children: [
                          ElevatedButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(
                              builder: (content) => QuizPage6(categoryTitle: widget.categoryTitle.toString(), categoryId: widget.categoryId.toString()))),
