...
import 'package:signlearn/model/question4.dart';

class QuizPage4 extends StatefulWidget {
  final String categoryTitle, categoryId;
  const QuizPage4({Key? key, required this.categoryTitle, required this.categoryId}) : super(key: key);
  @override
  State<QuizPage4> createState() => _QuizPageState();
}
                  ...
                  children: [
                          ElevatedButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(
                              builder: (content) => QuizPage4(categoryTitle: widget.categoryTitle.toString(), categoryId: widget.categoryId.toString()))),
