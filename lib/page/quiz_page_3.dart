...
import 'package:signlearn/model/question3.dart';

class QuizPage3 extends StatefulWidget {
  final String categoryTitle, categoryId;
  const QuizPage3({Key? key, required this.categoryTitle, required this.categoryId}) : super(key: key);
  @override
  State<QuizPage3> createState() => _QuizPageState();
}
                  ...
                  children: [
                          ElevatedButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(
                              builder: (content) => QuizPage3(categoryTitle: widget.categoryTitle.toString(), categoryId: widget.categoryId.toString()))),
