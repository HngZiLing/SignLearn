...
import 'package:signlearn/model/question7.dart';

class QuizPage7 extends StatefulWidget {
  final String categoryTitle, categoryId;
  const QuizPage7({Key? key, required this.categoryTitle, required this.categoryId}) : super(key: key);
  @override
  State<QuizPage7> createState() => _QuizPageState();
}

class _QuizPageState extends State<QuizPage7>{
                  ...
                  children: [
                          ElevatedButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(
                              builder: (content) => QuizPage7(categoryTitle: widget.categoryTitle.toString(), categoryId: widget.categoryId.toString()))),
